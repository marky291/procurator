...
<div id="link-{{ $component }}">
    ...
    <div class="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur p-4">
...
{{--        <img alt="" src="http://localhost/img/bg-blur-indigo.png" width="400" height="50" decoding="async" data-nimg="future" class="absolute opacity-20 -bottom-40 -right-44">--}}
        ...
        <div class="flex justify-between mb-5">
            <button class="px-2 mr-2 rounded-full border border-gray-700 text-sm flex items-center justify-center text-gray-700 dark:text-gray-300" onclick="window.livewire.emitTo('{{ $component }}', 'generate')">Generate
